...
public class NewsActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<NewsItem>> {
     ...
     * Any int can be chosen since wew only use 1 loader
     */
    ...
    public Loader<List<NewsItem>> onCreateLoader(int id, Bundle args) {
        ...
        //http://content.guardianapis.com/search?show-fields=byline&q=future&order-by=newest&from-date=2018-01-01&api-key=44053436-2b60-4f53-888b-561a139b173c
